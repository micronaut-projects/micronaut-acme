...
<7> Domain name(s) for the certificate. Can with be multiple domain names (ex. test.domain.com,stage.domain.com) or a wildcard domain name (*.domain.com)
